...
`;
    ...
    function generatePhenology(dates1) {
        ...
        const canvas = document.getElementById("nigracaudaChart");
        if (!canvas) {
            console.error("Canvas #nigracaudaChart not found.");
            return;
        }
