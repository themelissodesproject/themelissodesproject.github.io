// =========================
// Melissodes paululus Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_paululus"; // Your species-specific placeholder
const MAP_ID = "oregon_paululus";              // Unique ID for this map div
