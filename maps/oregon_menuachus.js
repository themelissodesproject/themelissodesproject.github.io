// =========================
// Melissodes menuachus Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_menuachus"; // Your species-specific placeholder
const MAP_ID = "oregon_menuachus";              // Unique ID for this map div
