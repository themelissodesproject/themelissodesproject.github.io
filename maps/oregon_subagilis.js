// =========================
// Melissodes subagilis Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_subagilis"; // Your species-specific placeholder
const MAP_ID = "oregon_subagilis";              // Unique ID for this map div
