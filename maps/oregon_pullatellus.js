// =========================
// Melissodes pullatellus Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_pullatellus"; // Your species-specific placeholder
const MAP_ID = "oregon_pullatellus";              // Unique ID for this map div
...
Melissodes pullatellus	44.4617	-123.1092	Scullen, H	1924-08-05	LaBerge, Walley	Adult	unknown		http://biodiversity.ku.edu/research/university-kansas-biodiversity-institute-data-publication-and-use-norms		https://www.gbif.org/occurrence/658125915		Linn, Oregon, US
Melissodes pullatellus	44.5414	-123.0055	Scullen, H	1937-08-12	LaBerge, Walley	Adult	unknown		http://biodiversity.ku.edu/research/university-kansas-biodiversity-institute-data-publication-and-use-norms		https://www.gbif.org/occurrence/657798800		Linn, Oregon, US
`;
