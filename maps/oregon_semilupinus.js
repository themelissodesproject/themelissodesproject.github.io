// =========================
// Melissodes semilupinus Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_semilupinus"; // Your species-specific placeholder
const MAP_ID = "oregon_semilupinus";              // Unique ID for this map div
