// =========================
// Melissodes tepidus Map Visualization
// =========================

(() => {   // <<< BEGIN IIFE — isolates everything

const SPECIES_PLACEHOLDER = "oregon_tepidus"; // Your species-specific placeholder
const MAP_ID = "oregon_tepidus";              // Unique ID for this map div
